...
if __name__ == "__main__":
    ...
    with mlflow.start_run() as run:
        ...
        # save model locally then log as artifact (fixes DagsHub upload issue)
        with tempfile.TemporaryDirectory() as tmp_dir:
            tmp_model_path = os.path.join(tmp_dir, "delivery_time_pred_model")
            mlflow.sklearn.save_model(model, tmp_model_path, signature=model_signature)
            mlflow.log_artifacts(tmp_model_path, artifact_path="delivery_time_pred_model")
